...
version. e.g. https://github.com/jirutka/minima/blob/v2.5.0/README.md*
*Running `bundle show jekyll-minima` will provide you with the local path to your current theme version.*
